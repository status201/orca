...
<script>
    window.__pageData = {
        ...
        thumbnailStoreUrl: @js(route('assets.thumbnail.store', $asset)),
        translations: {
            tagAlreadyExists: @js(__('Tag already exists')),
            failedToLoadVideo: @js(__('Failed to load video. The video format may not be supported by your browser.')),
            failedToGeneratePreviews: @js(__('Failed to generate video previews. The video format may not be supported by your browser.')),
            videoPreviewSuccess: @js(__('Video preview generated successfully.')),
            failedToUploadThumbnail: @js(__('Failed to upload thumbnail.')),
            networkError: @js(__('Network error. Please check your connection and try again.')),
            confirmRemoveAiTag: @js(__('Are you sure you want to remove the AI tag')),
