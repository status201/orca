...
136 tests across 21 spec files (129 literal `test()` calls plus 7 generated by the two
`tools.spec.js` loops), on top of the 4 in `global.setup.js` — so
`npx playwright test --list` reports **140 tests in 22 files**. Counting only literal
